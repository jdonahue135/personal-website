...
export const testimonials = [
  {
    ...
    text:
      "In a fast-moving world, it's great to have someone like Jake who has a demonstrated track record of being adaptive to new challenges. He created a brand new inside sales program from scratch that is now at the core of our business strategy. The best part is throughout all of this he was very proactive, resourceful and able to learn on his own.",
  },
  {
    name: "Paige",
    title: "President, Blank Label",
    text:
      "Jake is a passionate, committed and detail-oriented professional. His performance was consistently top notch and I would not hesitate to work with him on any project big or small. His adaptability and problem solving capabilities made him a huge asset to our team. ",
  },
  {
    name: "Connor",
    title: "Director of Operations, Blank Label",
    text:
      "Strong, analytical problem-solving skills were the cornerstone of his successes. Extremely reliable and hard-working, and a great teammate to have in the office. Would recommend without hesitation.",
  },
];
